   ...
   <section className="">
     <div className="  relative   overflow-y-hidden border-b-[7px] border-gray-700 ">
      ...
      <div className="gradient absolute   top-0  w-full h-full">
        <div className="flex justify-center flex-col py-[7rem] items-center w-full">
          ...
          <Button
            ...
            variant="contained"
            className=" my-3 bg-red-600  hover:bg-red-700 py-2 font-normal text-lg px-4 text-white capitalize"
          >
            Get Started
          </Button>
        </div>
