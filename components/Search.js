...
export default function Search() {
  const menuItems = [
    { name: "Blue bettle", link: "/movies/blue-bettle" },
    { name: "Black adam", link: "/movies/black-adam" },
    { name: "Spiderman across ..", link: "/movies/spiderman-into" },
    { name: "Man of steal", link: "/movies/man-of-steal" },
    { name: "After earth", link: "/movies/after-earth" },
    { name: "Smallville", link: "/movies/smallville" },
    { name: "Avengers end game", link: "/movies/end-game" },
    { name: "The flash", link: "/movies/the-flash" },
    { name: "Shang-chi & legends.", link: "/movies/shang-chi" },
    { name: "Justice League", link: "/movies/justice-league" },
  ];
